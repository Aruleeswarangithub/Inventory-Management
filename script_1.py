# Update base.html template to include notification dropdown in navbar
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr class="table-danger">
                                    ...
                                    <td>
                                        <a href="{{ url_for('add_movement') }}?product={{ item.product_id }}" 
...
print("✅ Updated base.html with notification system in navbar!")
print("✅ Created notifications.html template for detailed notification view!")